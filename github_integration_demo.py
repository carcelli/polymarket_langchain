...
from agents.subagents.github_agent import (
...
def demonstrate_github_tools():
    ...
    if "error" in status:
        ...
        print("💡 Make sure your GitHub App credentials are configured in .env")
        return
...
def demonstrate_automated_reporting():
    ...
    print("\\n4. 🤖 Automated Market Analysis Reporting")
    print("-" * 30)
    ...
    print("\\n💡 To actually create this GitHub issue, run:")
...
def demonstrate_subagent_integration():
    ...
    from agents.subagents import create_github_subagent, get_all_subagents

    # Create GitHub subagent
    github_subagent = create_github_subagent()
    print("🤖 GitHub Subagent Created:")
    ...
    print("\\n🎯 Subagent Use Cases:")
    print("• Main Agent: 'Create a GitHub issue with the latest market analysis'")
    print("• GitHub Subagent: Handles the actual issue creation and formatting")
    print("• Result: Clean main context + properly formatted GitHub issue")
...
def main():
    ...
    try:
        ...
        print(f"\\n❌ Demo failed: {e}")
        print("\\n💡 Make sure your .env file has GitHub credentials:")
