...
from agents.ml_strategies.{strategy_class.lower()} import {strategy_class}
from market_analysis_workflow import MarketAnalyzer
...
if __name__ == "__main__":
    # Run basic tests
    print(f"🧪 Running basic tests for {strategy_name}...")
    ...
    print(f"🎉 Basic tests passed for {{strategy_name}}!")
'''
    ...
    def generate_strategy_comparison_test(self, strategy_names: List[str]) -> str:
        ...
        strategy_imports = "\n".join([f"from agents.ml_strategies.{name.lower()} import {name}" for name in strategy_names])
...
class TestStrategyComparison:
    ...
    def test_strategy_diversity(self, strategies, test_markets):
        ...
        print(f"\\n🎭 Strategy Diversity: {{avg_diversity:.2f}} average unique recommendations per market")
...
if __name__ == "__main__":
    ...
    print("🎉 Strategy comparison tests ready!")
'''
...
from agents.ml_strategies.{strategy_name.lower()} import {strategy_name}
...
class Test{strategy_name}Validation:
    ...
    def test_cross_validation_stability(self, strategy, large_training_dataset):
        ...
        if hasattr(strategy, 'regressor'):
            ...
            print(f"\\n📊 Cross-validation MSE: {{mean_score:.4f}} ± {{std_score:.4f}}")
    ...
    def test_prediction_calibration(self, strategy, large_training_dataset):
        ...
        print(f"\\n🎯 Calibration Error: {{avg_calibration_error:.4f}}")
    ...
    def test_robustness_to_noise(self, strategy, large_training_dataset):
        ...
        print(f"\\n🛡️ Prediction Stability: {{stability_ratio:.2f}} (lower is better)")
    ...
    def test_confidence_calibration(self, strategy, large_training_dataset):
        ...
        for confidence_threshold in [0.1, 0.3, 0.5, 0.7, 0.9]:
            ...
            if total_predictions > 10:
                ...
                print(f"   Confidence ≥{{confidence_threshold:.1f}}: {{accuracy:.2f}} accuracy ({{total_predictions}} predictions)")
...
if __name__ == "__main__":
    print(f"🧪 Running validation tests for {strategy_name}...")
    ...
    features = strategy.prepare_features(test_market)
    print(f"✅ Feature engineering: {{features.shape[1]}} features prepared")

    print(f"🎉 Validation tests ready for {{strategy_name}}!")
'''
