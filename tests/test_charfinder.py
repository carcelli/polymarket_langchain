...
class TestCharacterFinderClient:
    ...
    def test_unicode_search_basic(self):
        ...
        try:
            ...
            pytest.skip("Character finder server not running - start with: python -m polymarket_agents.utils.charfinder_server")
...
class TestAsyncCharacterFinderClient:
    ...
    async def test_async_connection_error(self):
        ...
        with pytest.raises(ConnectionError):
            await async_query_unicode_names("test", host='127.0.0.1', port=99999, timeout=1.0)
...
class TestServerIntegration:
    ...
    def test_server_availability(self):
        ...
        try:
            ...
            if result != 0:
                pytest.skip("Character finder server not running on localhost:2323 - start with: python -m polymarket_agents.utils.charfinder_server")
...
def test_convenience_function():
    ...
    try:
        ...
        smiley_found = any('SMILEY' in result.upper() or 'FACE' in result.upper()
                          for result in results)
