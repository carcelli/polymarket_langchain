        ...
        try:
            ...
            if outcome_prices_raw:
                try:
                    ...
                    logger.warning(f"Could not parse outcome prices: {outcome_prices_raw}, error: {e}")
...
if __name__ == "__main__":
    ...
    if market_data:
        ...
        print(f"   Up Price: {market_data['up_price']:.3f} ({market_data['up_price']*100:.1f}%)")
        print(f"   Down Price: {market_data['down_price']:.3f} ({market_data['down_price']*100:.1f}%)")
