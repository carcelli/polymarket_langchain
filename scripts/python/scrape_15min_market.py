    ...
    try:
            ...
            try:
                ...
                if page_props:
                    ...
                    if market_data:
                        ...
                        print(
                            "   💾 Full page props saved to: polymarket_page_data.json"
                        )
                        return page_props
        ...
        for script in all_scripts:
            if script.string and "market" in script.string.lower():
                ...
                condition_id_matches = re.findall(
                    r'"condition_id"\s*:\s*"(0x[a-fA-F0-9]+)"', script.string
                )
...
def main():
    ...
    parser.add_argument("--url", type=str, help="Full Polymarket event URL")
    parser.add_argument(
        "--current", action="store_true", help="Try to scrape current 15-minute market"
    )
