...
def search_market_by_time(timestamp: int) -> Optional[Dict]:
    ...
    for pattern in search_patterns:
        params = {"search": pattern, "limit": 50}
        ...
        try:
            ...
            for market in markets:
                ...
                if (
                    f"{dt.strftime('%B')} {dt.day}" in question
                    or f"January {dt.day}" in question
                ):
...
def get_all_recent_updown_markets() -> List[Dict]:
    ...
    url = "https://gamma-api.polymarket.com/markets"
    params = {"search": "Up or Down", "limit": 100}
...
def main():
    ...
    parser.add_argument(
        "--all", action="store_true", help="Find all recent Up or Down markets"
    )
