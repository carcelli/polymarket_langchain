...
def fetch_markets(search: str, active: bool = None, closed: bool = None, limit: int = 200) -> List[Dict]:
    """Query Gamma API."""
...
def main():
    ...
    all_btc = [m for m in all_btc if any(kw in m.get('question', '').lower() for kw in btc_keywords)]
