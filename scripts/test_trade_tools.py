...
from agents.tools.trade_tools import execute_market_order, execute_limit_order, cancel_all_orders
...
class TestTradeTools(unittest.TestCase):
    ...
    def test_execute_market_buy_mock(self, MockPolymarket):
        ...
        mock_poly.client.post_order.return_value = {"status": "success", "orderID": "buy_1"}
    ...
    def test_execute_market_sell_mock(self, MockPolymarket):
        ...
        mock_poly.client.post_order.return_value = {"status": "success", "orderID": "sell_1"}
