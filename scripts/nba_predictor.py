...
NBA_STANDINGS = {
    # Eastern Conference
    "Cavaliers": (36, 6), "Celtics": (31, 13), "Knicks": (28, 16),
    "Magic": (25, 21), "Bucks": (23, 19), "Heat": (21, 20),
    "Pacers": (24, 20), "76ers": (15, 25), "Hawks": (21, 21),
    "Bulls": (18, 24), "Pistons": (20, 22), "Nets": (14, 28),
    "Raptors": (9, 34), "Hornets": (8, 31), "Wizards": (6, 33),
    
    # Western Conference  
    "Thunder": (35, 7), "Grizzlies": (30, 15), "Rockets": (28, 14),
    "Mavericks": (25, 21), "Warriors": (21, 21), "Lakers": (23, 18),
    "Nuggets": (25, 17), "Clippers": (23, 19), "Suns": (20, 21),
    "Timberwolves": (22, 20), "Kings": (19, 22), "Spurs": (19, 21),
    "Trail Blazers": (14, 28), "Jazz": (10, 31), "Pelicans": (12, 30),
}
...
class NBAPredictor:
    ...
    def predict_winner(self, 
                      team_a: str, 
                      team_b: str, 
                      is_team_a_home: bool = True) -> Tuple[str, float, Dict]:
        """
...
def demo_predictions():
    ...
    for home_team, away_team, _, market_price in games:
        winner, prob, details = predictor.predict_winner(home_team, away_team, is_team_a_home=True)
        
        edge, rec = predictor.calculate_edge(home_team, away_team, True, market_price)
        
        print(f"\n{home_team} vs {away_team} (Home: {home_team})")
        print(f"  Records: {home_team} {details['team_a_record']} ({details['team_a_pct']:.3f}) | "
